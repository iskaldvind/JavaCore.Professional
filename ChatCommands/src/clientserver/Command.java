...
public class Command implements Serializable {
    ...
    public static Command updateUserCommand(String login, String newName) {
        Command command = new Command();
        command.type = CommandType.UPDATE_USER;
        command.data = new UpdateUserCommandData(login, newName);
        return command;
    }

    public static Command updateOkCommand() {
        Command command = new Command();
        command.type = CommandType.UPD_OK;
        return command;
    }

    public static Command updateErrorCommand(String updateErrorMessage) {
        Command command = new Command();
        command.type = CommandType.UPD_ERROR;
        command.data = new UpdateErrorCommandData(updateErrorMessage);
        return command;
    }
